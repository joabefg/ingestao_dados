"""
Ingestão de dados em arquivo (csv) e bancos ralacionais (mysql)
e nosql (elasticsearch)
"""
...
if __name__ == '__main__':
    ...
    funcioarios_mock = gerar_dados_funcionarios(NUM_FUNCIONARIOS)
    print(funcioarios_mock)